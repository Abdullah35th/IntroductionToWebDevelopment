...
var awesomeSauce = false; //changed tracking to awesomeSauce lol
...
function toggle() {
    ...
    if (awesomeSauce) {
        ...
        this.innerText = "Click here if you want to be awesome :D";

        mouseX.innerText = "awesomeSauceX";
        mouseY.innerText = "awesomeSauceY";
    } else {
        this.classList.remove("btn-success");
        this.classList.add("btn-danger");
        this.innerText = "Click here if you don't want to be awesome anymore D:";
    }
